...
{
    public class RaiseShipmentApproval
    {
        ...
        string shipment_approval = "//button[contains(.,'Shipment Approval')]";
        ...
        public RaiseShipmentApproval(IWebDriver driver)
        {
            this.driver = driver;
        }
        ...
        public void Shipment_Approval()
        {
            driver.FindElement(By.XPath(shipment_approval)).Click();
            Thread.Sleep(1500);
        }
