...
{
    [TestFixture]
    public class Standard_Technical_EvaluationTest:ReportsGenerationClass
    {
        Technical_Evaluation TE;

        [Test, Order(1)]
        [Category("Standard Technical Evaluation of Suppliers")]
        public void Technical()
        {
            ...
            try
            {
                ...
                TE.Quotation();
                TE.Closed_Document();
                TE.Closed_Document_Search("STANDARD RFQ CREATION 34 of 40 on JAN2022");  //Go to line 50
                TE.Document();
                TE.Doc_Action();
                TE.Unlock_Technical();
                ...
                TE.Quotation();
                TE.Closed_Document();
                TE.Closed_Document_Search("STANDARD RFQ CREATION 34 of 40 on JAN2022");  //go to line 70
                TE.Evaluate_Doc();
                TE.Doc_Action();
                ...
                TE.Quotation();
                TE.Closed_Document();
                TE.Closed_Document_Search("STANDARD RFQ CREATION 34 of 40 on JAN2022"); 
                TE.Document();
                TE.Doc_Action();
