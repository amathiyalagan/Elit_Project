...
namespace ELIT_Selenium_TR.Config
{
    ...
    public abstract class ReportsGenerationClass
    {
        ...
        public void BeforeTest()
        {
            ...
            _driver = new ChromeDriver(@"C:\Users\ATSTC004\source\repos\ELIT_Selenium_PRJ\ELIT_Selenium_PRJ\Driver\", options);  //Location of Chrome Driver.EXE in the project
